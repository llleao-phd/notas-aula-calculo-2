        ...
        \begin{figure}[htbp]
                \centering
                    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
                        ...
                        % Text Node
                        \draw (98.54,254.3) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$x$};
                        % Text Node
                        \draw (215.96,214.03) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$y$};
                        % Text Node
                        \draw (116.96,34.03) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$z$};
                    \end{tikzpicture}
...
\begin{definition}
    Sejam \(f:D_f\subset\R^2 \to \R\), \((x_0,y_0)\) um ponto de acumulação de \(D_f\) e \(L\in\R\). Definimos \[\lim_{(x,y)\to(x_0,y_0)} f(x,y) = L\] se, para todo \(\varepsilon>0\), existe \(\delta>0\) tal que, para todo \((x,y)\in D_f\), \[(x,y)\in D_f, \text{ e } 0 < \|(x,y)-(x_0,y_0)\| < \delta \Rightarrow |f(x,y) - L| < \delta.\]\index{Limite}
            \begin{figure}[htbp]
                \centering
                    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
                        ...
                        % Text Node
                        \draw (320.61,245.13) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$x$};
                        % Text Node
                        \draw (66.17,8.48) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$y$};
                        % Text Node
                        \draw (403.81,33.99) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$\mathbb{R}$};
                        % Text Node
                        \draw (28.23,102.42) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$\textcolor[rgb]{0.96,0.65,0.14}{D_{f}}$};
                        % Text Node
                        \draw (160.78,136.27) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 65; green, 117; blue, 5 }  ,opacity=1 ]  {$( x_{0} ,y_{0})$};
                        % Text Node
                        \draw (159.55,159.71) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 139; green, 87; blue, 42 }  ,opacity=1 ]  {$( x,y)$};
                        % Text Node
                        \draw (152.44,140.49) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\delta $};
                        % Text Node
                        \draw (432.8,114.47) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$L$};
                        % Text Node
                        ...
                        % Text Node
                        \draw (435.47,183.13) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$L-\varepsilon $};
                        % Text Node
                        \draw (433.8,55.07) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$L+\varepsilon $};
                        % Text Node
                        \draw (425.88,87.73) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize,color={rgb, 255:red, 139; green, 87; blue, 42 }  ,opacity=1 ]  {$f( x,y)$};
                    \end{tikzpicture}
                \caption{Limte}
                \label{fig:Limte}
            \end{figure}
...
\begin{enumerate}
    \item (Teorema do sanduíche): Se \(f(x,y) \leq g(x,y) \leq h(x,y)\) para \(0 < \|(x,y) - (x_0,y_0)\| < r\) e \[\lim_{(x,y)\to(x_0,y_0)} f(x,y) = L = \lim_{(x,y)\to (x_0,y_0)} h(x,y),\] então \(\lim_{(x,y)\to(x_0,y_0)} g(x,y) = L\).
    ...
    \item Se \(\lim_{(x,y)\to(x_0,y_0)} f(x,y) = L\) e \(\lim_{(x,y)\to(x_0,y_0)} g(x,y)\), então
        ...
        \end{enumerate}
    \item (Cnservação do sinal): Se \(\lim_{(x,y)\to(x_0,y_0)} f(x,y) = L\) e \(L > 0\) {\cb (\(L<0\))}, então existe \(\delta>0\) tal que, para todo \((x,y)\in D_f\) tal que \(0 < \|(x,y) - (x_0,y_0)\| < \delta\), \(f(x,y) > 0\) {\cb (\(f(x,y) < 0\))}.
\end{enumerate}
...
\begin{proposition}\label{prop.composta}
    ...
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
        ...
        \draw (447.2,203.78) node [anchor=north west, inner sep=0.75pt, font=\footnotesize] {$\mathbb{R}$};
        ...
        \draw (122.84,153.16) node [anchor=north west, inner sep=0.75pt, font=\tiny, color={rgb, 255:red, 65; green, 117; blue, 5}, opacity=1] {$(x_{0}, y_{0})$};
        \draw (111.94,141.93) node [anchor=north west, inner sep=0.75pt, font=\tiny] {$\delta$};
        ...
        \draw (679.2,203.18) node [anchor=north west, inner sep=0.75pt, font=\footnotesize] {$\mathbb{R}$};
...
\begin{definition}
    Sejam \(f: D_f\subset \R^2 \to \R\) e \((x_0,y_0)\in D_f\) um ponto de acumulação de \(D_f\). Dizemos que \(f\) é contínua \index{Funções! Contínua} em \((x_0,y_0)\) se \[\displaystyle\lim_{\substack{x\to x_0 \\ y\to y_0}} f(x,y) = f(x_0,y_0). \]
\end{definition}
