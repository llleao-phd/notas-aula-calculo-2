...
\begin{definition}
    Uma função de duas variáveis reais a valores reais é uma função \(F: D_F \subset \R^2 \to \R\). Ou seja, a cada \((x,y)\in D_F\), \(F\) associa um único valor real \(z = f(x,y)\in\R\).\index{Funções}
\end{definition}

A seguir para uma função \(F: D_F\subset\R^2 \to \R\), \(D_F\) é chamado \textbf{domínio}\index{Funções! Domínio} de \(F\) e \[\operatorname{Im}_F = \{z = f(x,y) \in \R : (x,y)\in D_F\}\] é a \textbf{imagem}\index{Funções! Imagem} de \(F\). Além disso, \(x\) e \(y\) são chamadas de \textbf{variáveis independentes} e \(z\) a \textbf{variável dependente}.
...
\begin{definition}
    Uma \textbf{função polinomial}\index{Funções! Polinomial} de duas variáveis reais a valores reais é uma função \(f:\R^2 \to \R\) dada por \[f(x,y) = \sum_{m+n\leq p} a_{m,n}x^m y^n,\] no qual \(p\in\N\) é fixo (chamado \textbf{grau do polinômio}) e \(a_{m,n}\in\R\) são dados.
\end{definition}

\begin{example}
    \begin{enumerate}
        \item \(f(x,y) = 3x^3 y^2 - \frac{1}{3} x y + \sqrt{2}\) é uma função polinomial de grau 5.
        \item \(f(x,y) = ax + by + c\), com \(a,b,c\in\R\) é uma função polinomial de grau 1. Chamamos tal função de \textbf{função afim}\index{Funções! Afim}.
        \item \(f(x,y) = ax + by\), com \(a,b\in\R\) é uma função polinomial (mais ainda, é uma função afim) e tal função é chamada \textbf{função linear}\index{Funções! Linear}.
    \end{enumerate}
\end{example}

\begin{definition}
    Toda função \(f:D_f \subset\R^2 \to \R\) dada por \[f(x,y) = \frac{p(x,y)}{q(x,y)},\] com \(p\) e \(q\) funções polinomiais, é chamada \textbf{função racional}\index{Funções! Racional} e \[\{D_f = (x,y)\in\R^2 : q(x,y)\neq 0\}.\]
\end{definition}
...
\begin{definition}
    Uma função \(f:D_f \subset \R^2 \to \R\) se chama \textbf{função homogênea} de grau \(\lambda\) se \[f(tx,ty) = t^\lambda f(x,y)\] para todo \(t>0\) e todo \((x,y)\in D_f\) tais que \((tx,ty)\in D_f\).
\end{definition}
        ...
        \item \(f(x,y) = \frac{xe^{\frac{x}{y}}}{x^2 + y^2}\) é homogênea de grau \(-1\). De fato, \[D_f = (x,y)\in\R^2 : y\neq 0\] e, para todo \(t>0\) e \((x,y)\in D_f\), temos \((tx,ty)\in D_f\). Além disso,
            \begin{align*}
                f(tx,ty)
                    ...
                    & = \frac{xe^{\frac{x}{y}}}{t(x^2 + y^2)} \\
                    & = \frac{1}{t} \frac{xe^{\frac{x}{y}}}{x^2 + y^2} = t^{-1} f(x,y).
            \end{align*}
    \end{enumerate}
\end{example}
        ...
        \begin{figure}[htbp]
            \centering
                \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
                    ...
                    % Text Node
                    \draw (122.32,115.24) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\textcolor[rgb]{0.29,0.56,0.89}{( x,y)}$};
                    % Text Node
                    \draw (124.32,182.44) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$x$};
                    % Text Node
                    \draw (155.6,117.2) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$y$};
                \end{tikzpicture}                    
...
\begin{definition}
    Seja \(f:D_f\subset\R^2 \to \R\) uma função de duas variáveis reais a valores reais. O conjunto \[G_f = \{(x,y,z)\in\R^3 : z = f(x,y),\, (x,y)\in D_f\}\] é chamado \textbf{gráfico} de \(f\)\index{Funções! Gráfico}.
\end{definition}
        ...
        \begin{figure}[htbp]
            \centering
                \begin{tikzpicture}[x=0.5pt,y=0.5pt,yscale=-1,xscale=1]
                    ...
                    % Text Node
                    \draw (314.45,212.19) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 65; green, 117; blue, 5 }  ,opacity=1 ]  {$( x,y)$};
                    % Text Node
                    \draw (341.53,100.91) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 65; green, 117; blue, 5 }  ,opacity=1 ]  {$z\ =\ f( x,y)$};
                \end{tikzpicture}                    
...
\begin{example}[Função linear]
    ...
    O gráfico de \(f\) é a superfície \(S\) de equação \(3x + 2y + z = 6\). No 1º octante,
        ...
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=0.6\textwidth]{Gráfico de f(x,y) = 6 - 3x - 2y.png}               
...
\begin{example}[Semiesfera]
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.6\textwidth]{Gráfico de f(x,y) = sqrt(9-x^2-y^2).png}               
...
\begin{example}[Parabolóide]
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.6\textwidth]{Gráfico de f(x,y) = x^2 + y^2.png}               
...
\begin{example}[Parabolóide elíptico]
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.6\textwidth]{Gráfico de f(x,y) = 4x^2 + y^2.png}
...
\begin{definition}
    Sejam \(z = f(x,y)\) uma função de duas variáveis e \(k\in\operatorname{Im}_f\). O conjunto de todos os pontos \((x,y)\in D_f\) tais que \(f(x,y) = k\) é chamado \textbf{curva de nível}\index{Curva de nível} de \(f\) correspondente ao nível \(k\).
\end{definition}
...
\begin{example}
    ...
    %uncomment if require: \path (0,300); %set diagram left start at 0, and has height of 300
                    ...
                    % Text Node
                    \draw (296.4,181.67) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$x$};
                    % Text Node
                    \draw (186.4,72.13) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$y$};
                    % Text Node
                    \draw (194,212.07) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\textcolor[rgb]{0.82,0.01,0.11}{k=6}$};
                    % Text Node
                    \draw (218.67,206.07) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 245; green, 166; blue, 35 }  ,opacity=1 ]  {$\textcolor[rgb]{0.96,0.65,0.14}{k=4}$};
                    % Text Node
                    \draw (230,197.07) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 245; green, 166; blue, 35 }  ,opacity=1 ]  {$\textcolor[rgb]{0.49,0.83,0.13}{k=2}$};
                    % Text Node
                    \draw (243.56,176.88) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 245; green, 166; blue, 35 }  ,opacity=1 ]  {$\textcolor[rgb]{0.74,0.06,0.88}{k=0}$};
                    % Text Node
                    \draw (533.07,184.67) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$x$};
                    % Text Node
                    \draw (423.07,75.13) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$y$};
                    % Text Node
                    \draw (490.8,195.3) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 245; green, 166; blue, 35 }  ,opacity=1 ]  {$\textcolor[rgb]{0.74,0.06,0.88}{k=0}$};
                    % Text Node
                    \draw (474.17,163.3) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 245; green, 166; blue, 35 }  ,opacity=1 ]  {$\textcolor[rgb]{0.49,0.83,0.13}{k=2}$};
                    % Text Node
                    \draw (453.51,137.97) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 245; green, 166; blue, 35 }  ,opacity=1 ]  {$\textcolor[rgb]{0.96,0.65,0.14}{k=4}$};
                    % Text Node
                    \draw (432.27,105.3) node [anchor=north west][inner sep=0.75pt]  [font=\tiny,color={rgb, 255:red, 245; green, 166; blue, 35 }  ,opacity=1 ]  {$\textcolor[rgb]{0.82,0.01,0.11}{k=6}$};
                \end{tikzpicture}
...
\begin{example}
    ...
    %uncomment if require: \path (0,300); %set diagram left start at 0, and has height of 300
                    ...
                    % Text Node
                    \draw (269.6,174.8) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$x$};
                    % Text Node
                    \draw (194,95.27) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$y$};
                    % Text Node
                    \draw (344.4,218.4) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$x$};
                    % Text Node
                    \draw (395.07,63.53) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$z$};
                    % Text Node
                    \draw (193.7,183.85) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\textcolor[rgb]{0.74,0.06,0.88}{k=3}$};
                    % Text Node
                    \draw (193.2,165.8) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\textcolor[rgb]{0.49,0.83,0.13}{k=2}$};
                    % Text Node
                    \draw (193.45,153.5) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\textcolor[rgb]{0.82,0.01,0.11}{k=1}$};
                    % Text Node
                    \draw (190.95,142) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\textcolor[rgb]{0.29,0.56,0.89}{k=0}$};
                    % Text Node
...
\begin{figure}[htbp]
    ...
    %uncomment if require: \path (0,300); %set diagram left start at 0, and has height of 300
                    ...
                    % Text Node
                    \draw (74.67,72.27) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$y$};
                    % Text Node
                    \draw (227.73,205.4) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$x$};
                    % Text Node
                    \draw (276.4,50.53) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$z$};
                    % Text Node
                    \draw (124.15,129.09) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\textcolor[rgb]{0.49,0.83,0.13}{k=2}$};
                    % Text Node
                    \draw (124.12,119.36) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\textcolor[rgb]{0.82,0.01,0.11}{k=1}$};
                    % Text Node
                    \draw (123.9,96.14) node [anchor=north west][inner sep=0.75pt]  [font=\tiny]  {$\textcolor[rgb]{0.29,0.56,0.89}{k=\frac{1}{2}}$};
                    % Text Node
...
\begin{definition}
    Uma função de três variáveis a valores reais , definida em \(D_f \subset\R^3\), é uma função que associa a cada terna ordenada \((x,y,z)\in D_f\) a um único número real \(w = f(x,y,z)\).
\end{definition}

\begin{definition}
    O gráfico de uma função de 3 variáveis é o conjunto \[G_f = \{(x,y,z,w)\in\R^4 : w = f(x,y,z),\, (x,y,z)\in D_f\}.\]
\end{definition}
...
\begin{definition}
    Sejam \(f:D_f\subset\R^3 \to \R\) uma função e \(k\in\operatorname{Im}_f\). O conjunto dos pontos \((x,y,z)\in D_f\) tais que \(f(x,y,z) = k\) é chamado de superfície de nível \(k\) de \(f\).\index{Superfície de nível}
\end{definition}
        ...
        \begin{figure}[htbp]
            \centering
                \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
                    ...
                    % Text Node
                    \draw (273.57,134.43) node [anchor=north west][inner sep=0.75pt]  [font=\footnotesize]  {$\sqrt{k}$};
                \end{tikzpicture}
